...
Filtering
Matrix
for the 2D Kernel (The Matrix mH)
% with support for different operations modes (Convolution / Correlation)
% and boundary
conditions(Zeros, Symmetric, Replicate, Circular).The
% function
should
match
the
...
's '
convmtx2()
' - https://www.mathworks.com/help/images/ref/convmtx2.html.
% Remarks:
% 1.
The
height and width
...
kernel
with zeros
    % (Either a row, column or both).according
    to
    the
    anchor
    of
...
Add
support
for any constant as boundary condition and not only 0.
% Release
Notes:
% -   1.0
.001
